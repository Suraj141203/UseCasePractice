		...
		<center>
			...
			<table width="100%" align="center">
				<div>
					...
					</label> <input type="text" name="quantity" placeholder="Please Enter Quantity"
				...
				<div>
						...
						</label> <%=HTMLUtility.getList("product", String.valueOf(bean.getProduct()), map)%></td>
				...
				<td align="center"><label>OrderDate</font> :
					...
					<div>
						...
						</label><input type="text" name="cost" size="25"
